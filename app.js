const menu = [
  ...
  function display(elements){
    const menuItems = elements.map(function(item){
        console.log(item);
  ...
  function displayButtons(){
    ...
    const btnsCategory = menu.reduce(function(acc,curr){
    ...
    function filterMenu(){
      ...
      item.addEventListener("click",function(e){
        ...
        console.log(current);
        const categoriesMatch = menu.filter(function(item){
        ...
        if(current==='all'){
          console.log("Im displayinhg all");
          display(menu);
        }else{
          console.log("im invoked");
          console.log(categoriesMatch);
          display(categoriesMatch);
        }
